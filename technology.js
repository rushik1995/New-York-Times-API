...
var getdataworld = function(){
    return new Promise(function(resolve,reject){
        ...
        let urlrequest = "https://api.nytimes.com/svc/topstories/v2/technology.json?api-key=ZN5Mx5zr98gINjsjZHm49H4kD0cAViZv";
...
card_head.innerText = "TECHNOLOGY"
...
function createmainleft(title,abstract,url,multimedia,dates){
var card = document.createElement('div');
card.setAttribute("class","card mb-3");
card.setAttribute("style","max-width: 100vw; margin-top: 20px; border: 1px solid black;");
container.appendChild(card);
...
var card_head = document.createElement('h5');
card_head.setAttribute("class","card-title secttion-card");
card_head.setAttribute("style","color: lightblue;");
card_head.innerText = "TECHNOLOGY"
card_body.appendChild(card_head);
